...
from thermompnn_benchmarking import compute_centrality, ALPHABET
...
def main(cfg, args):
    ...
    models = {
        "ThermoMPNN": TransferModelPL.load_from_checkpoint('checkpoints/example_training_mega_epoch=55_val_ddG_spearman=0.79.ckpt', cfg=cfg).model
